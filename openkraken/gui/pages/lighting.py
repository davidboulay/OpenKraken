...
:data:`openkraken.backend.lighting_fx.MODES`), a row of clickable colour swatches
...
repainted once a second from :func:`openkraken.backend.lighting_fx.frame` so the
...
*Apply* builds a :class:`~openkraken.config.LightingConfig`, calls
...
from openkraken.config import LightingChannelConfig, LightingConfig
