...
:func:`krakencam.backend.lcd_render.render` with the latest sample data via a 2 s
...
*Apply* builds a :class:`~krakencam.config.LcdConfig`, calls ``engine.apply_lcd``
...
from krakencam.config import LcdConfig
