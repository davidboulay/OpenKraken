...
combo (Liquid / CPU / GPU temp), a :class:`~krakencam.gui.widgets.curve_editor.CurveEditor`
...
feedback loops). *Apply* collects a :class:`~krakencam.config.ChannelConfig` and
...
from krakencam.config import ChannelConfig
from krakencam.gui.widgets.curve_editor import CurveEditor
