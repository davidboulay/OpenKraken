...
Shows five :class:`~krakencam.gui.widgets.gauge.GaugeTile` instances fed from the
engine's ``sample_ready`` signal, and two
:class:`~krakencam.gui.widgets.graph.TimeSeriesGraph` widgets re-fed from
...
from krakencam.gui.widgets.gauge import GaugeTile
from krakencam.gui.widgets.graph import TimeSeriesGraph
